// gcc `pkg-config --cflags --libs dbus-1` solve1.c -ldbus-1 -o solve1
...
int main(){
    ...
    message = dbus_message_new_method_call("cn.edu.ustc.lug.hack.FlagService", "/cn/edu/ustc/lug/hack/FlagService", "cn.edu.ustc.lug.hack.FlagService", "GetFlag1");
    if (message == NULL) {
        fprintf(stderr, "Message Null\n");
        exit(1);
    }

    char const *arg = "Please give me flag1";
